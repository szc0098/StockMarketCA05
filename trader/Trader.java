...
public class Trader {
	...
	public void tradePerformed(Order o, double matchPrice)
		...
		if(o.getClass() == BuyOrder.class){
			...
			this.cashInHand = this.cashInHand + matchPrice*o.getSize();
            for(Order traderPosition: position){
            	if(traderPosition.getStockSymbol().equals(o.getStockSymbol())){
            		if(o.getSize() < traderPosition.getSize()){
            			traderPosition.setSize(traderPosition.getSize() - o.getSize());
            		}
            		else{
            			this.position.remove(traderPosition);
            		}
            		break;
            	}
            }
